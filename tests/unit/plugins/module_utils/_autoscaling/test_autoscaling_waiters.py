...
from ansible_collections.amazon.aws.plugins.module_utils._autoscaling.waiters import waiter_factory

if not HAS_BOTOCORE:
    pytestmark = pytest.mark.skip("test_waiters.py requires botocore")


class TestAutoscalingWaiters:
    """Test suite for autoscaling waiter factory."""
