...
from ansible_collections.amazon.aws.plugins.module_utils._elb.waiters import waiter_factory

if not HAS_BOTOCORE:
    pytestmark = pytest.mark.skip("test_waiters.py requires botocore")


class TestELBWaiters:
    """Test suite for classic ELB waiter factory."""
