...
key_details = {'KeyMetadata':
               {'aliases': ['mykey'],
                ...
                'key_id': 'mrk-12345678', 'key_manager': 'CUSTOMER',
                'key_policies': [{'Id': 'key-default-1',
                                 'Statement': [{'Action': 'kms:*', 'Effect': 'Allow',
                ...
                'multi_region_configuration': {
                    ...
                    'primary_key': {'arn': 'arn:aws:kms:us-east-1:12345678:key/mrk-12345678', 'region': 'us-east-1'},
                    'replica_keys': []
                    },
                'origin': 'AWS_KMS',
                'tags': {'Hello': 'World2'}
