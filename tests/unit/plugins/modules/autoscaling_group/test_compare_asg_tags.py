...
class TestCompareAsgTags:
    def test_no_changes_empty_tags(self):
        ...
        tags_to_delete, tags_to_set = asg_module.compare_asg_tags([], [], purge_tags=True)
    ...
    def test_no_changes_identical_tags(self):
        ...
        tags_to_delete, tags_to_set = asg_module.compare_asg_tags(current_tags, want_tags, purge_tags=True)
    ...
    def test_remove_tags_without_purge(self):
        ...
        tags_to_delete, tags_to_set = asg_module.compare_asg_tags(current_tags, want_tags, purge_tags=False)
