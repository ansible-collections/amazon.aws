...
from ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager import ProcessManager
from ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager import SSMProcessManagerTimeOutFailure
from ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager import SSMSessionManager
...
@patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager._create_polling_obj")
...
class TestSSMSessionManager:
    ...
    @patch("os.fdopen")
    @patch("os.close")
    @patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager.ProcessManager")
    @patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager.Popen")
    @patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager.openpty")
    @patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager.to_text")
    @patch("ansible_collections.community.aws.plugins.plugin_utils.ssmsessionmanager._create_polling_obj")
