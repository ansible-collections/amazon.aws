...
validate_test_data = [
    ...
    # Path tests
    (dict(path="/12345abcd"), "path must begin and end with /", "path must begin and end with /", "path must begin and end with /",),
    (dict(path="/12345abcd/"), None, None, None),
    (dict(path=f"/{'12345abcd0'*51}/"), None, None, None),  # Max length 512 chars
    (dict(path=f"/{'12345abcd/'*51}a/"), "path may not exceed 512", "path may not exceed 512", "path may not exceed 512",),
    ...
    (dict(name=f"{'12345abcd0'*12}123456789"), "name may not exceed 64", "name may not exceed 64", "name may not exceed 128",),
