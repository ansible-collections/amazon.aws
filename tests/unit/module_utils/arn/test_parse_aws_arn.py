...
arn_good_values = [
    ...
    dict(partition="aws", service="rds", region="es-east-1", account_id="000000000000", resource="snapshot:rds:my-db-snapshot"),
    dict(partition="aws", service="cloudformation", region="us-east-1", account_id="012345678901", resource="changeSet/Ansible-StackName-c6884247ede41eb0"),
]
