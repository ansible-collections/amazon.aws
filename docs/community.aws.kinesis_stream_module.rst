.. _community.aws.kinesis_stream_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enable or Disable encryption on the Kinesis Stream.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The type of encryption.</div>
                        <div>Defaults to <code>KMS</code></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The GUID or alias for the KMS key.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The name of the Kinesis Stream you are managing.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The length of time (in hours) data records are accessible after they are added to the stream.</div>
                        <div>The default retention period is 24 hours and can not be less than 24 hours.</div>
                        <div>The maximum retention period is 168 hours.</div>
                        <div>The retention period can be modified during any point in time.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The number of shards you want to have with this stream.</div>
                        <div>This is required when <em>state=present</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Create or Delete the Kinesis Stream.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A dictionary of resource tags of the form: <code>{ tag1: value1, tag2: value2 }</code>.</div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                            <div>Number of hours messages will be kept for a Kinesis Stream.</div>
                    <br/>
            ...
            <tr>
                ...
                <td>when state == present.</td>
                <td>
                            <div>The amazon resource identifier</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:kinesis:east-side:123456789:stream/test-stream</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>when state == present.</td>
                <td>
                            <div>The name of the Kinesis Stream.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">test-stream</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>when state == present.</td>
                <td>
                            <div>The current state of the Kinesis Stream.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when state == present.</td>
                <td>
                            <div>Dictionary containing all the tags associated with the Kinesis stream.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;Name&#x27;: &#x27;Splunk&#x27;, &#x27;Env&#x27;: &#x27;development&#x27;}</div>
                </td>
            </tr>
    </table>
    <br/><br/>
