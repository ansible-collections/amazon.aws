...
.. _community.aws.aws_direct_connect_gateway_:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The ID of an existing Direct Connect Gateway.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>Name of the Direct Connect Gateway to be created or deleted.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>Set <em>state=present</em> to ensure a resource is created.</div>
                                            <div>Set <em>state=absent</em> to remove a resource.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The VPN gateway ID of an existing virtual gateway.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>How long to wait for the association to be deleted.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                                                        <div>The attributes of the Direct Connect Gateway</div>
                                                                <br/>
                                    </td>
            </tr>
                                                            <tr>
                ...
                <td></td>
                <td>
                                                                        <div>ASN on the amazon side.</div>
                                                                <br/>
                                    </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                                                                        <div>The ID of the direct connect gateway.</div>
                                                                <br/>
                                    </td>
            </tr>
                                <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>direct_connect_gateway_name</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                ...
                <td></td>
                <td>
                                                                        <div>The name of the direct connect gateway.</div>
                                                                <br/>
                                    </td>
            </tr>
                                <tr>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>direct_connect_gateway_state</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                ...
                <td></td>
                <td>
                                                                        <div>The state of the direct connect gateway.</div>
                                                                <br/>
                                    </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                                                                        <div>The AWS account ID of the owner of the direct connect gateway.</div>
                                                                <br/>
                                    </td>
            </tr>
