.. _community.aws.ecs_task_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The list of container instances on which to deploy the task.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>How many new instances to start.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>A list of group names or group IDs for the task.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>A list of subnet IDs to which the task is attached.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>A dictionary of values to pass to the new instances.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>A value showing who or what started the task (for informational purposes).</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>
                        <div>Tags that will be added to ecs tasks on start and run</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>details about the task that was started</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the of the cluster that hosts the task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the container running the task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The timestamp of when the task was created.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The last recorded status of the task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The container overrides set for this task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The timestamp of when the task was started.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The used who started the task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The timestamp of when the task was stopped.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The reason why the task was stopped.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The Amazon Resource Name (ARN) that identifies the task.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>only when details is true</td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the task definition.</div>
                    <br/>
                </td>
            </tr>
