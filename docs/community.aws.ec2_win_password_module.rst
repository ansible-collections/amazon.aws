.. _community.aws.ec2_win_password_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The instance id to get the password data from.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The private key (usually stored in vault).</div>
                        <div>Conflicts with <em>key_file</em>,</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Path to the file containing the key pair used on the instance.</div>
                        <div>Conflicts with <em>key_data</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The passphrase for the instance key pair. The key must use DES or 3DES encryption for this module to decrypt it. You can use openssl to convert your password protected keys if they do not use DES or 3DES. ex) <code>openssl rsa -in current_key -out new_key -des3</code>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether or not to wait for the password to be available before returning.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Number of seconds to wait before giving up.</div>
                </td>
            </tr>
    </table>
    <br/>
