    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-style: italic; font-size: small; color: darkgreen">added in 1.6</div>                </td>
                                <td>
                                                                                                                                                            </td>
                                                                <td>
                    ...
                    <div style="font-style: italic; font-size: small; color: darkgreen">added in 1.8</div>                </td>
                                <td>
                                                                                                                                                                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>no</li>
                                                                                                                                                                                                <li>yes</li>
                    ...
                    <div style="font-style: italic; font-size: small; color: darkgreen">added in 1.4</div>                </td>
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                    ...
                    <div style="font-style: italic; font-size: small; color: darkgreen">added in 1.5</div>                </td>
                                <td>
                                                                                                                                                                                                                    <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>no</li>
                                                                                                                                                                                                <li><div style="color: blue"><b>yes</b>&nbsp;&larr;</div></li>
