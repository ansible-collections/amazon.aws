.. _community.aws.redshift_cross_region_snapshots_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the cluster to configure cross-region snapshots for.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The region to copy snapshots to.</div>
            ...
            <tr>
                ...
                <td>
                        <div>A grant for Amazon Redshift to use a master key in the <em>destination_region</em>.</div>
                        <div>See <a href='http://boto3.readthedocs.io/en/latest/reference/services/redshift.html#Redshift.Client.create_snapshot_copy_grant'>http://boto3.readthedocs.io/en/latest/reference/services/redshift.html#Redshift.Client.create_snapshot_copy_grant</a></div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: copy_grant</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>snapshot_retention_period</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>The number of days to keep cross-region snapshots for.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Create or remove the cross-region snapshot configuration.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
