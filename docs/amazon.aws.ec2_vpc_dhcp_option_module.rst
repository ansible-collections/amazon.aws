.. _amazon.aws.ec2_vpc_dhcp_option_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Whether to delete the old VPC DHCP option set when associating a new one. This is primarily useful for debugging/development purposes when you want to quickly roll back to the old option set. Note that this setting will be ignored, and the old DHCP option set will be preserved, if it is in use by any other VPC. (Otherwise, AWS will return an error.)</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The resource_id of an existing DHCP options set. If this is specified, then it will override other settings, except tags (which will be updated to match)</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A list of hosts to set the DNS servers for the VPC to. (Should be a list of IP addresses rather than host names.)</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The domain name to set in the DHCP option sets</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>For any DHCP options not specified in these parameters, whether to inherit them from the options set already applied to vpc_id, or to reset them to be empty.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>netbios_name_servers</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>
                ...
                <td>
                        <div>List of hosts to advertise as NetBIOS servers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>netbios_node_type</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>NetBIOS node type to advertise in the DHCP options. The AWS recommendation is to use 2 (when using netbios name services) <a href='https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html'>https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html</a></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>List of hosts to advertise as NTP servers for the VPC.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>create/assign or remove the DHCP options. If state is set to absent, then a DHCP options set matched either by id, or tags and options will be removed if possible.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Tags to be applied to a VPC options set if a new one is created, or if <em>dhcp_options_id</em> is provided. (options must match)</div>
            ...
            <tr>
                ...
                <td>
                        <div>VPC ID to associate with the requested DHCP option set. If no vpc id is provided, and no matching option set is found then a new DHCP option set is created.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether the dhcp options were changed</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                            <div>The boto2-style DHCP options created, associated or found</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when available</td>
                <td>
                            <div>The domain name for hosts in the DHCP option sets</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;my.example.com&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>when available</td>
                <td>
                            <div>The IP addresses of up to four domain name servers, or AmazonProvidedDNS.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;10.0.0.1&#x27;, &#x27;10.0.1.1&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>when available</td>
                <td>
                            <div>The IP addresses of up to four NetBIOS name servers.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;10.0.0.1&#x27;, &#x27;10.0.1.1&#x27;]</div>
                </td>
            ...
            <tr>
                ...
                <td>when available</td>
                <td>
                            <div>The NetBIOS node type (1, 2, 4, or 8).</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when available</td>
                <td>
                            <div>The IP addresses of up to four Network Time Protocol (NTP) servers.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;10.0.0.1&#x27;, &#x27;10.0.1.1&#x27;]</div>
                </td>
            ...
            <tr>
                ...
                <td>when available</td>
                <td>
                            <div>The DHCP options created, associated or found</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The DHCP configuration for the option set</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;{&quot;key&quot;: &quot;ntp-servers&quot;, &quot;values&quot;: [{&quot;value&quot;: &quot;10.0.0.2&quot; , &quot;value&quot;: &quot;10.0.1.2&quot;}]}&#x27;, &#x27;{&quot;key&quot;: &quot;netbios-name-servers&quot;, &quot;values&quot;: [{value&quot;: &quot;10.0.0.1&quot;}, {&quot;value&quot;: &quot;10.0.1.1&quot; }]}&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The aws resource id of the primary DCHP options set created or found</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">dopt-0955331de6a20dd07</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The ID of the AWS account that owns the DHCP options set.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">012345678912</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td></td>
                <td>
                            <div>The tags to be applied to a DHCP options set</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;{&quot;Key&quot;: &quot;CreatedBy&quot;, &quot;Value&quot;: &quot;ansible-test&quot;}&#x27;, &#x27;{&quot;Key&quot;: &quot;Collection&quot;, &quot;Value&quot;: &quot;amazon.aws&quot;}&#x27;]</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>when available</td>
                <td>
                            <div>The aws resource id of the primary DCHP options set created, found or removed</div>
                    <br/>
                </td>
            </tr>
    </table>
