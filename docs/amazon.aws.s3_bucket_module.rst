    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enable API compatibility with Ceph. It takes into account the S3 API subset working with Ceph in order to provide the same module behaviour where possible.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Delete bucket&#x27;s ownership controls.</div>
                        <div>This option cannot be used together with a <em>object_ownership</em> definition.</div>
                        <div>Management of bucket ownership controls requires botocore&gt;=1.18.11.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>Describes the default server-side encryption to apply to new objects in the bucket. In order to remove the server-side encryption, the encryption needs to be set to &#x27;none&#x27; explicitly.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>The JSON policy as a string. Set to the string <code>&quot;null&quot;</code> to force the absence of a policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                        <div>With Requester Pays buckets, the requester instead of the bucket owner pays the cost of the request and the data download from the bucket.</div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
