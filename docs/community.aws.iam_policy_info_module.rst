.. _community.aws.iam_policy_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Name of IAM resource you wish to retrieve inline policies for. In other words, the user name, group name or role name.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Type of IAM resource you wish to retrieve inline policies for.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Name of a specific IAM inline policy you with to retrieve.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A list of names of all of the IAM inline policies on the queried object</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A list containing the matching IAM inline policy names and their data</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>success</td>
                <td>
                            <div>The JSON document representing the inline IAM policy</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The Name of the inline policy</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>A list of matching names of the IAM inline policies on the queried object</div>
                    <br/>
                </td>
            </tr>
    </table>
