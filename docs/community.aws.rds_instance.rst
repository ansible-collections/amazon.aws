                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The daily time range (in UTC) of at least 30 minutes, during which automated backups are created if automated backups are enabled using <em>backup_retention_period</em>. The option must be in the format of &quot;hh24:mi-hh24:mi&quot; and not conflict with <em>preferred_maintenance_window</em>.</div>
                                                                <div style="font-size: small; color: darkgreen"><br/>aliases: backup_window</div>
                                    </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that authorizes Amazon RDS to access the Amazon S3 bucket on your behalf.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The identifier for the database engine that was backed up to create the files stored in the Amazon S3 bucket.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The version of the database that the backup files were created from.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>always</td>
                <td>
                                                                        <div>The port that the database engine is listening on.</div>
                                                                <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
