...
.. _community.aws.aws_ses_identity_policy_:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The SES identity to attach or remove a policy from. This can be either the full ARN or just
    the verified email or domain.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">json</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>A properly formatted JSON sending authorization policy. Required when <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The name used to identify the policy within the scope of the identity it&#x27;s attached to.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>Whether to create(or update) or delete the authorization policy on the identity.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                                                        <div>A list of all policies present on the identity after the operation.</div>
                                                                <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;ExamplePolicy&#x27;]</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
