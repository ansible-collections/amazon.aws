.. _community.aws.ec2_placement_group_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A list of names to filter on. If a listed group does not exist, there will be no corresponding entry in the result; no error will be raised.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
