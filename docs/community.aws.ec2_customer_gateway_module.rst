.. _community.aws.ec2_customer_gateway_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Internet-routable IP address for customers gateway, must be a static address.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Name of the customer gateway.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li>static</li>
                                    <li><div style="color: blue"><b>dynamic</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>The type of routing.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Create or terminate the Customer Gateway.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>details about the gateway that was created.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when exists and gateway is available.</td>
                <td>
                            <div>The Border Gateway Autonomous System Number.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">65123</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>when exists and gateway is available.</td>
                <td>
                            <div>gateway id assigned by amazon.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">cgw-cb6386a2</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>when exists and gateway is available.</td>
                <td>
                            <div>ip address of your gateway device.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when gateway exists and is available.</td>
                <td>
                            <div>state of gateway.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when gateway exists and is available, and when tags exist.</td>
                <td>
                            <div>Any tags on the gateway.</div>
                    <br/>
                </td>
            </tr>
            <tr>
