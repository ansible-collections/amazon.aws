    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A list of cookies to forward to the origin for this cache behavior.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>lambda_function_associations</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>
            ...
            <tr>
                <td colspan="4">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>default_origin_domain_name</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>s3_origin_access_identity_enabled</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        ...
                        <div>Will automatically create an Identity for you if no <em>s3_origin_config</em> is specified.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Specify origin access identity for S3 origins.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Existing origin access identity in the format <code>origin-access-identity/cloudfront/OID_ID</code>.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div><em>price_class=PriceClass_All</em> consists of the areas United States, Canada, Europe, Japan, India, South America, Australia, Hong Kong, Philippines, S. Korea, Singapore &amp; Taiwan.</div>
                        <div>AWS defaults this to <code>PriceClass_All</code>.</div>
                        <div>Valid values are <code>PriceClass_100</code>, <code>PriceClass_200</code> and <code>PriceClass_All</code></div>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td colspan="4">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>purge_custom_error_responses</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                        <div>Apply a restriction based on the location of the requester.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>cloudfront_default_certificate</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Key pair IDs that CloudFront is aware of for each trusted signer.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether trusted signers are in use.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when there are trusted signers</td>
                <td>
                            <div>Number of trusted signers.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;key_pair_id&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Aliases that refer to the distribution.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;test.example.com&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Amazon Resource Name of the distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:cloudfront::123456789012:distribution/E1234ABCDEFGHI</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>CloudFront cache behaviors.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of cache behaviors.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Methods allowed by the cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Methods cached by the cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of cached methods.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;HEAD&#x27;, &#x27;GET&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Count of cached methods.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of methods allowed by the cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;HEAD&#x27;, &#x27;GET&#x27;]</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of methods allowed by the cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether compression is turned on for the cache behavior.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Default Time to Live of the cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Values forwarded to the origin for this cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Cookies to forward to the origin.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Which cookies to forward to the origin for this cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>when <em>forward=whitelist</em></td>
                <td>
                            <div>The names of the cookies to forward to the origin for this cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when list is not empty</td>
                <td>
                            <div>List of cookies to forward.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">my_cookie</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Count of cookies to forward.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Which headers are used to vary on cache retrievals.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when list is not empty</td>
                <td>
                            <div>List of headers to vary on.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of headers to vary on.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether the query string is used in cache lookups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Which query string keys to use in cache lookups.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when list is not empty</td>
                <td>
                            <div>List of query string cache keys to use in cache lookups.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of query string cache keys to use in cache lookups.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Lambda function associations for a cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when list is not empty</td>
                <td>
                            <div>List of lambda function associations.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;lambda_function_arn&#x27;: &#x27;arn:aws:lambda:123456789012:us-east-1/lambda/lambda-function&#x27;, &#x27;event_type&#x27;: &#x27;viewer-response&#x27;}]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Count of lambda function associations.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Maximum Time to Live.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">31536000</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Path pattern that determines this cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">/path/to/files/*</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Whether smooth streaming is enabled.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>ID of origin reference by this cache behavior.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">origin_abcd</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Whether trusted signers are enabled for this cache behavior.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of trusted signers.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Policy of how to handle http/https.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">redirect-to-https</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of cache behaviors.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Idempotency reference given when creating CloudFront distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1484796016700</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>Any comments you want to include about the distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">my first CloudFront distribution</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>Custom error responses to use for error handling.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of custom error responses.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Minimum time to cache this error response.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Origin response code that triggers this error response.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Response code to return to the requester.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">500</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Path that contains the error page to display.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">/errors/5xx.html</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Count of custom error response items</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Default cache behavior.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The object that you want CloudFront to request from your origin (for example, index.html) when a viewer requests the root URL for your distribution.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Difference between previous configuration and new configuration.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Domain name of CloudFront distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">d1vz8pzgurxosf.cloudfront.net</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>Whether the CloudFront distribution is enabled or not.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Version of HTTP supported by the distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">http2</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>CloudFront distribution ID.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">E123456ABCDEFG</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>in_progress_invalidation_batches</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                    </div>
                ...
                <td>always</td>
                <td>
                            <div>The number of invalidation batches currently in progress.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether IPv6 is enabled.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">True</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Date and time distribution was last modified.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2017-10-13T01:51:12.656000+00:00</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>S3 bucket logging destination.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">logs-example-com.s3.amazonaws.com</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Whether logging is enabled.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">True</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether to log cookies.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Prefix added to logging object names.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">cloudfront/test</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Origins in the CloudFront distribution.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Custom headers passed to the origin.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Configuration of the origin.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Port on which HTTP is listening.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Port on which HTTPS is listening.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Policy of which protocols are supported.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">https-only</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Timeout for reads to the origin.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>SSL protocols allowed by the origin.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of SSL protocols.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;TLSv1&#x27;, &#x27;TLSv1.1&#x27;, &#x27;TLSv1.2&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Count of SSL protocols.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Domain name of the origin.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">test-origin.example.com</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Subdirectory to prefix the request from the S3 or HTTP origin.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when s3_origin_access_identity_enabled is true</td>
                <td>
                            <div>Origin access identity configuration for S3 Origin.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td></td>
                <td>
                            <div>The origin access id as a path.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">origin-access-identity/cloudfront/EXAMPLEID</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Price class of CloudFront distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">PriceClass_All</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                ...
                <td>always</td>
                <td>
                            <div>Restrictions in use by CloudFront.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Controls the countries in which your content is distributed.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of country codes allowed or disallowed.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">xy</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Type of restriction.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">blacklist</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Status of the CloudFront distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">InProgress</div>
                </td>
            </tr>
            <tr>
                <td colspan="6">
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Certificate used by CloudFront distribution.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when certificate comes from ACM</td>
                <td>
                            <div>ARN of ACM certificate.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:acm:us-east-1:123456789012:certificate/abcd1234-1234-1234-abcd-123456abcdef</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Reference to certificate.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:acm:us-east-1:123456789012:certificate/abcd1234-1234-1234-abcd-123456abcdef</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Where certificate comes from.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">acm</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Minimum SSL/TLS protocol supported by this distribution.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">TLSv1</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Support for pre-SNI browsers or not.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">sni-only</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>ID of Web Access Control List (from WAF service).</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">abcd1234-1234-abcd-abcd-abcd12345678</div>
                </td>
            </tr>
    </table>
    <br/><br/>
