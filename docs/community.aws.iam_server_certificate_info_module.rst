.. _community.aws.iam_server_certificate_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the server certificate you are retrieving attributes for.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The Amazon resource name of the server certificate</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:iam::911277865346:server-certificate/server-cert-name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>certificate_body</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The date and time this server certificate will expire, in ISO 8601 format.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2017-06-15T12:00:00+00:00</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>success</td>
                <td>
                            <div>The path of the server certificate</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The 21 character certificate id</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">ADWAJXWTZAXIPIMQHMJPO</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>server_certificate_name</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
                ...
                <td>success</td>
                <td>
                            <div>The name of the server certificate</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">server-cert-name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>success</td>
                <td>
                            <div>The date and time this server certificate was uploaded, in ISO 8601 format.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2015-04-25T00:36:40+00:00</div>
                </td>
            </tr>
    </table>
    <br/><br/>
