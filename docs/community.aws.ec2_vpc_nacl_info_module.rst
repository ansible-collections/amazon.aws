.. _community.aws.ec2_vpc_nacl_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A list of Network ACL IDs to retrieve information about.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: nacl_id</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>A list of NACL egress rules with the following format.</div>
                            <div><code>[rule no, protocol, allow/deny, v4 or v6 cidr, icmp_type, icmp_code, port from, port to]</code></div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[[100, &#x27;all&#x27;, &#x27;allow&#x27;, &#x27;0.0.0.0/0&#x27;, None, None, None, None]]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>A list of NACL ingress rules with the following format.</div>
                            <div><code>[rule no, protocol, allow/deny, v4 or v6 cidr, icmp_type, icmp_code, port from, port to]</code></div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[[100, &#x27;tcp&#x27;, &#x27;allow&#x27;, &#x27;0.0.0.0/0&#x27;, None, None, 22, 22]]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>True if the NACL is the default for its VPC.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the Network Access Control List.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>A list of subnet IDs that are associated with the NACL.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>A dict of tags associated with the NACL.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the VPC that the NACL is attached to.</div>
                    <br/>
                </td>
            </tr>
