...
.. _community.aws.ecs_service_info_:
...
- This module was called ``ecs_service_facts`` before Ansible 2.9, returning ``ansible_facts``. Note that the :ref:`ecs_service_info <ecs_service_info_module>` module no longer returns ``ansible_facts``!
