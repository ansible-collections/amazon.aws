...
- This module was called ``efs_facts`` before Ansible 2.9, returning ``ansible_facts``. Note that the :ref:`efs_info <efs_info_module>` module no longer returns ``ansible_facts``!
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>Creation Token of Amazon EFS file system.</div>
                                                                <div style="font-size: small; color: darkgreen"><br/>aliases: creation_token</div>
                                    </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>List of tags of Amazon EFS. Should be defined as dictionary.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>List of targets on which to filter the returned results.</div>
                                            <div>Result must match all of the specified targets, each of which can be a security group ID, a subnet ID or an IP address.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>always</td>
                <td>
                                                                        <div>url of file system with leading dot from the time AWS EFS required to add network suffix to EFS address</div>
                                                                <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">.fs-xxxxxxxx.efs.us-west-2.amazonaws.com:/</div>
                                    </td>
                ...
                <td>when botocore &gt;= 1.10.57 and throughput_mode is set to &quot;provisioned&quot;</td>
                <td>
                                                                        <div>throughput provisioned in Mibps</div>
                                                                <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">15.0</div>
                                    </td>
            </tr>
                                <tr>
                                <td colspan="1">
                ...
                <td>when botocore &gt;= 1.10.57</td>
                <td>
                                                                        <div>mode of throughput for the file system</div>
                                                                <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">bursting</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
