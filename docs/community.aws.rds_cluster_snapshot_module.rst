.. _community.aws.rds_cluster_snapshot_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Whether to copy all tags from <em>source_db_cluster_snapshot_identifier</em> to <em>db_cluster_snapshot_identifier</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The identifier of the DB cluster to create a snapshot for.</div>
                        <div>Required when <em>state=present</em>.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: cluster_id, cluster_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The identifier of the DB cluster snapshot.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: snapshot_id, id, snapshot_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>source_db_cluster_snapshot_identifier</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>The identifier of the DB cluster snapshot to copy.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Specify the desired state of the snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether or not to wait for snapshot creation or deletion.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
...
.. note::
   - Retrieve the information about a specific DB cluster or list the DB cluster snapshots for a specific DB cluster can de done using :ref:`community.aws.rds_snapshot_info <community.aws.rds_snapshot_info_module>`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Availability zone of the database from which the snapshot was created.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">us-west-2a</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2019-06-15T10:15:56.221000+00:00</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">ansible-test-16638696</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>always</td>
                <td>
                            <div>Amazon Resource Name for the snapshot.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:rds:us-west-2:123456789012:snapshot:ansible-test-16638696-test-snapshot</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">ansible-test-16638696-test-snapshot</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>always</td>
                <td>
                            <div>Specifies the name of the database engine for this DB cluster snapshot.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Provides the engine mode of the database engine for this DB cluster snapshot.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">5.6.mysql_aurora.1.22.5</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>always</td>
                <td>
                            <div>Version of the cluster from which the snapshot was created.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">5.6.mysql_aurora.1.22.5</div>
                </td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Whether IAM database authentication is enabled.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The Amazon Web Services KMS key identifier is the key ARN, key ID, alias ARN, or alias name for the KMS key.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Provides the master username for this DB cluster snapshot.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Port on which the database is listening.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2019-06-15T10:46:23.776000+00:00</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>always</td>
                <td>
                            <div>How the snapshot was created (always manual for this module!).</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>source_db_cluster_snapshot_arn</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
                ...
                <td>always</td>
                <td>
                            <div>If the DB cluster snapshot was copied from a source DB cluster snapshot, the ARN for the source DB cluster snapshot, otherwise, null.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Tags applied to the snapshot.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>ID of the VPC in which the DB lives.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">vpc-09ff232e222710ae0</div>
                </td>
            </tr>
    </table>
    <br/><br/>
