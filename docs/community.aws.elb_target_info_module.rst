.. _community.aws.elb_target_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Whether or not to get target groups not used by any load balancers.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>What instance ID to get information for.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>a list of target groups to which the instance is registered to</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ARN of the target group</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;arn:aws:elasticloadbalancing:eu-west-1:111111111111:targetgroup/target-group/deadbeefdeadbeef&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>Which target type is used for this group</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;ip&#x27;, &#x27;instance&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>A list of targets that point to this instance ID</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>when an AZ is associated with this instance</td>
                <td>
                            <div>which availability zone is explicitly associated with this target</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The target health description.</div>
                            <div>See following link for all the possible values <a href='https://boto3.readthedocs.io/en/latest/reference/services/elbv2.html#ElasticLoadBalancingv2.Client.describe_target_health'>https://boto3.readthedocs.io/en/latest/reference/services/elbv2.html#ElasticLoadBalancingv2.Client.describe_target_health</a></div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>if <em>state!=present</em></td>
                <td>
                            <div>description of target health</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;Target desregistration is in progress&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>if <em>state!=healthy</em></td>
                <td>
                            <div>reason code for target health</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;Target.Deregistration in progress&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;healthy&#x27;, &#x27;draining&#x27;, &#x27;initial&#x27;, &#x27;unhealthy&#x27;, &#x27;unused&#x27;, &#x27;unavailable&#x27;]</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>the target ID referring to this instance</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;i-deadbeef&#x27;, &#x27;1.2.3.4&#x27;]</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>which port this target is listening on</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
