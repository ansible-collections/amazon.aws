    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The date and time when the Spot Instance request was created.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>when instance exists</td>
                <td>
                            <div>The instance ID, if an instance has been launched to fulfill the Spot Instance request.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The behavior when a Spot Instance is interruped.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Additional information for launching instances.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Described the monitoring of an instance.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>Indicated whether detailed monitoring is enabled.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>when creating a network interface when launching an instance</td>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>launched_availability_zone</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                    </div>
                ...
                <td>always</td>
                <td>
                            <div>The availability zone in which the request is launched.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The product description associated with the Spot Instance.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the Spot Instance request.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The state of the Spot Instance request.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Extra information about the status of the Spot Instance request.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>The status code.</div>
                            <div>See https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-request-status.html#spot-instance-request-status-understand for codes.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The description of the status code.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The date and time of the most recent status update in UTC format.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of tags associated with the resource.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The Spot Instance request type.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The end date of the request in UTC format.</div>
                    <br/>
                </td>
            </tr>
