.. _community.aws.elb_target_group_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>When set to &quot;yes&quot;, output contains targets health description</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The names of the target groups.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The Amazon Resource Names (ARN) of the target groups.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>a list of target groups</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>deregistration_delay_timeout_seconds</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>always</td>
                <td>
                            <div>The amount time for Elastic Load Balancing to wait before changing the state of a deregistering target from draining to unused.</div>
                    <br/>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>health_check_interval_seconds</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                    </div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The destination for the health check request.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">/index.html</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">traffic-port</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The protocol to use to connect with the target.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>health_check_timeout_seconds</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                    </div>
                ...
                <td>always</td>
                <td>
                            <div>The amount of time, in seconds, during which no response means a failed health check.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;http_code&#x27;: &#x27;200&#x27;}</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The port on which the targets are listening.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>stickiness_lb_cookie_duration_seconds</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">lb_cookie</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>always</td>
                <td>
                            <div>The tags attached to the target group.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">arn:aws:elasticloadbalancing:ap-southeast-2:01234567890:targetgroup/mytargetgroup/aabbccddee0044332211</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">mytargetgroup</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-"></div>
                    <b>targets_health_description</b>
                    <a class="ansibleOptionLink" href="#return-" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">complex</span>
                    </div>
                </td>
                <td>when collect_targets_health is enabled</td>
                <td>
                            <div>Targets health description.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>The port to check target health.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">80</div>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">i-0123456789</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder">&nbsp;</td>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The target health status.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>The state of the target health.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of consecutive health check failures required before considering the target unhealthy.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the VPC for the targets.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
