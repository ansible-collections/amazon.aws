.. _community.aws.iam_password_policy_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Allow users to change their password.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: allow_password_change</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">6</div>
                </td>
                <td>
                        <div>Minimum password length.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: minimum_password_length</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Prevents users from change an expired password.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: password_expire, expire</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Maximum age for a password in days. When this option is 0 then passwords do not expire automatically.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: password_max_age</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>pw_reuse_prevent</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                    </div>
                ...
                <td>
                        <div>Prevent re-use of passwords.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: password_reuse_prevent, prevent_reuse</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Require lowercase letters in password.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Require numbers in password.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Require symbols in password.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>require_uppercase</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>Require uppercase letters in password.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Specifies the overall state of the password policy.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
