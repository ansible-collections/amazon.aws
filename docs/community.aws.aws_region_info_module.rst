.. _community.aws.aws_region_info_module:
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>See <a href='https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRegions.html'>https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRegions.html</a> for possible filters.</div>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>on success</td>
                <td>
                            <div>Regions that match the provided filters. Each element consists of a dict with all the information related to that region.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{ &#x27;endpoint&#x27;: &#x27;ec2.us-west-1.amazonaws.com&#x27;, &#x27;region_name&#x27;: &#x27;us-west-1&#x27; }]</div>
                </td>
            </tr>
    </table>
    <br/><br/>
