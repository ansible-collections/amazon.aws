.. _community.aws.lightsail_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>ID of the instance blueprint image.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Bundle of specification info for the instance.</div>
                        <div>Required when <em>state=present</em>.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Name of the key pair to use with the instance.</div>
                        <div>If <em>state=present</em> and a key_pair_name is not provided, the default keypair from the region will be used.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        ...
                        <div><em>rebooted</em> and <em>restarted</em> are aliases.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Launch script that can configure the instance with additional data.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Wait for the instance to be in state &#x27;running&#x27; before returning.</div>
                        <div>If <em>wait=false</em> an ip_address may not be returned.</div>
                        <div>Has no effect when <em>state=rebooted</em> or <em>state=absent</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>How long before <em>wait</em> gives up, in seconds.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>if a snapshot has been modified/created</div>
                    <br/>
