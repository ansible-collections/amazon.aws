.. _community.aws.ec2_snapshot_copy_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>An optional human-readable string describing purpose of the new Snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether or not the destination Snapshot should be encrypted.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>KMS key id used to encrypt snapshot. If not specified, AWS defaults to <code>alias/aws/ebs</code>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The source region the Snapshot should be copied from.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The ID of the Snapshot in source region that should be copied.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A hash/dictionary of tags to add to the new Snapshot; &#x27;{&quot;key&quot;:&quot;value&quot;}&#x27; and &#x27;{&quot;key&quot;:&quot;value&quot;,&quot;key&quot;:&quot;value&quot;}&#x27;</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Wait for the copied Snapshot to be in &#x27;Available&#x27; state before returning.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when snapshot copy is successful</td>
                <td>
                            <div>snapshot id of the newly created snapshot</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">snap-e9095e8c</div>
                </td>
            </tr>
    </table>
    <br/><br/>
