...
.. _community.aws.aws_s3_bucket_info_:
...
--------
- Lists S3 buckets in AWS
- This module was called ``aws_s3_bucket_facts`` before Ansible 2.9, returning ``ansible_facts``. Note that the :ref:`aws_s3_bucket_info <aws_s3_bucket_info_module>` module no longer returns ``ansible_facts``!
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                            ...
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;creation_date&#x27;: &#x27;2017-07-06 15:05:12 +00:00&#x27;, &#x27;name&#x27;: &#x27;my_bucket&#x27;}]</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
