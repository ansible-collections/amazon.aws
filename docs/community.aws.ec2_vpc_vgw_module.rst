.. _community.aws.ec2_vpc_vgw_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>the BGP ASN of the amazon side</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>name of the vgw to be created or deleted</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>dictionary of resource tags</div>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>ipsec.1</b>&nbsp;&larr;</div></li>
                        </ul>
                </td>
                <td>
                        <div>type of the virtual gateway to be created</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>the vpc-id of a vpc to attach or detach</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>vpn gateway id of an existing virtual gateway</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>number of seconds to wait for status during vpc attach and detach</div>
                </td>
            </tr>
    </table>
    <br/>
