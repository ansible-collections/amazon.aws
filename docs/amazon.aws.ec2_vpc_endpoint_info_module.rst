    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of DNS entires for the endpoint.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the private hosted zone.</div>
                    <br/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of security groups associated with the network interface.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of network interfaces for the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the AWS account that owns the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The policy document associated with the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Indicates whether the VPC is associated with a private hosted zone.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>Indicated whether the endpoint is being managed by its service.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of route table IDs associated with the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The name of the service to which the endpoint is associated.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of subnets associated with the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>List of tags associated with the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The ID of the endpoint.</div>
                    <br/>
                </td>
            </tr>
            <tr>
