.. _community.aws.ec2_instance_info_module:
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always if botocore version &gt;= 1.10.16</td>
                <td>
                            <div>The CPU options set for the instance.</div>
                    <br/>
                </td>
            </tr>
                                <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of threads per CPU core. On supported instance, a value of 1 means Intel Hyper-Threading Technology is disabled.</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">1</div>
                </td>
