.. _community.aws.cloudwatchlogs_log_group_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The Amazon Resource Name (ARN) of the CMK to use when encrypting log data.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether an existing log group should be overwritten on create.</div>
                        <div>Mutually exclusive with <em>purge_retention_policy</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Whether to purge the retention policy or not.</div>
                        <div>Mutually exclusive with <em>retention</em> and <em>overwrite</em>.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The number of days to retain the log events in the specified log group.</div>
                        <div>Valid values are: [1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 3653]</div>
                        <div>Mutually exclusive with <em>purge_retention_policy</em>.</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The key-value pairs to use for the tags.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Return the list of complex objects representing log groups</div>
                    <br/>
                </td>
            </tr>
                                <tr>
                ...
                <td>always</td>
                <td>
                            <div>The Amazon Resource Name (ARN) of the log group.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The creation time of the log group.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of metric filters.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>The number of bytes stored.</div>
                    <br/>
                </td>
            </tr>
