.. _amazon.aws.ec2_snapshot_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Description to be applied to the snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Device name of a mounted volume to be snapshotted.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Instance that has the required volume to snapshot mounted.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>last_snapshot_min_age</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                ...
                <td>
                        <div>If the volume&#x27;s most recent snapshot has started less than <em>last_snapshot_min_age</em> minutes ago, a new snapshot will not be created.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A dictionary of tags to add to the snapshot.</div>
                        <div>If the volume has a <code>Name</code> tag this will be automatically added to the snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Whether to add or create a snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Volume from which to take the snapshot.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Wait for the snapshot to be ready.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{ &#x27;Name&#x27;: &#x27;instance-name&#x27; }</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
