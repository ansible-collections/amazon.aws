        ...
        for option in current_option["options"]:
            for setting_name in new_options:
                if setting_name["option_name"] == option["option_name"]:
                    ...
                    # returned by the API
                    if any(
                        name in option.keys() - ["option_settings", "vpc_security_group_memberships"] and setting_name[name] != option[name]
                    ...
                    if any(
                        new_option_setting["name"] == current_option_setting["name"] and new_option_setting["value"] != current_option_setting["value"]
