...
def get_vpc_id(module: AnsibleAWSModule, connection, name: str, cidr_block: List[str], multi: bool) -> Optional[str]:
...
def main():
    ...
    try:
        vpc_id = vpc_id or get_vpc_id(module, connection, name, cidr_block, multi)
        if state == "present":
