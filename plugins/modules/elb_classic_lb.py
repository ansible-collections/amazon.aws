...
def main():
    argument_spec = dict(
        ...
        listeners=dict(default=None, required=False, type='list', elements='dict'),
        purge_listeners=dict(default=True, required=False, type='bool'),
        instance_ids=dict(default=None, required=False, type='list', elements='str'),
        purge_instance_ids=dict(default=False, required=False, type='bool'),
        zones=dict(default=None, required=False, type='list', elements='str'),
        purge_zones=dict(default=False, required=False, type='bool'),
        security_group_ids=dict(default=None, required=False, type='list', elements='str'),
        security_group_names=dict(default=None, required=False, type='list', elements='str'),
        health_check=dict(default=None, required=False, type='dict'),
        subnets=dict(default=None, required=False, type='list', elements='str'),
        purge_subnets=dict(default=False, required=False, type='bool'),
        scheme=dict(default='internet-facing', required=False, choices=['internal', 'internet-facing']),
        connection_draining_timeout=dict(default=None, required=False, type='int'),
        idle_timeout=dict(default=None, type='int', required=False),
        cross_az_load_balancing=dict(default=None, type='bool', required=False),
        stickiness=dict(default=None, required=False, type='dict'),
        access_logs=dict(default=None, required=False, type='dict'),
        wait=dict(default=False, type='bool', required=False),
        wait_timeout=dict(default=60, type='int', required=False),
